            ...
            <section id="how-it-works" className="relative w-full max-w-7xl mx-auto min-h-screen">
                <div className="py-36 space-y-4">
                    <div className="flex flex-col items-center justify-center">
                        <h1 className="font-semibold text-3xl">How Nexora Works?</h1>
                        <p className="leading-relaxed text-(--text-gray)">Simple steps to get digital assets and start building faster.</p>
                    </div>
                    <StepSection />
                </div>
            </section>
